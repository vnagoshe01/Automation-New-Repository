...
public class HandleDisableWebElement {
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		jse.executeScript("document.getElementById('name').value='vishakha'");
		
		//handle disable email text box
		Thread.sleep(2000);
		jse.executeScript("document.getElementById('email').value='vishu123@gmail.com'");
		
		// handle disable password text box
		Thread.sleep(2000);
		jse.executeScript("document.getElementById('password').value='vishakha123'");
